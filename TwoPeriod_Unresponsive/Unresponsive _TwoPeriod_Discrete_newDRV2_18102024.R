...
wd="/Users/elifnurdogruoz/Desktop/Tez Dosyaları/Supply Uncertainty/Single Period/Makale/TwoPeriod_Unresponsive"
setwd(wd)
...
file_name <- paste0("Unresponsive_TwoPeriod_newDRV2_part2", current_time, ".xlsx")
